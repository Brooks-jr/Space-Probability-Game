...
When a player reaches a total of 100(default) or how ever many points entered into the goal input field, the game ends and that player is the winner.
